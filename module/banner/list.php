...
<?php
    ...
    $queryBanner = mysqli_query($koneksi, "SELECT * FROM banner ORDER BY banner_id DESC limit $mulai_dari , $data_perhalaman");
    ...
    $hitungJumlah = mysqli_query($koneksi, "SELECT * FROM banner");
